...
public class selection extends JFrame implements ActionListener {
    ...
    selection(){
        ...
        addPatient.setBounds(40,20,150,20);
        ...
        ambulance.setBounds(200,20,150,20);
        ...
        billing.setBounds(40,60,150,20);
        ...
        inventory.setBounds(200,60,150,20);
        ...
        security.setBounds(360,60,150,20);
